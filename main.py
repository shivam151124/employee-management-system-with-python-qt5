...
class EmployeeApp(QWidget):
    def __init__(self):
        ...
        self.btnShowtable.clicked.connect(self.toggle_table)

        # Initially hide the table
        self.tableWidget.setVisible(False)
        self.btnShowtable.setText("Show Table")
    ...
    def toggle_table(self):
        # Correcting the visibility toggle
        if self.tableWidget.isVisible():
            self.tableWidget.setVisible(False)
            self.btnShowtable.setText("Show Table")
        else:
            self.tableWidget.setVisible(True)
            self.btnShowtable.setText("Hide Table")
